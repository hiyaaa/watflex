<template>
  <v-navigation-drawer v-model="Customizer_drawer" app temporary :right="!$vuetify.rtl">
    ...
    <div class="px-4 py-4">
      ...
      <v-item-group v-model="navbarColor">
    ...
    <div class="px-4 py-4">
      ...
      <v-item-group v-model="SidebarColor">
...
export default {
  ...
  data: () => ({
    right: false,
    SidebarColors: ["white", "#1d2228", "rgb(44, 59, 164)", "rgb(96, 44, 164)", "rgb(151, 210, 219)", "rgb(77, 86, 100)"],
    navbarColors: ["#1e88e6", "#21c1d6", "#fc4b6c", "#563dea", "white", "#ff9800"],
    themecolor: "#1e88e5",
    themecolors: ["#1e88e6", "#21c1d6", "#fc4b6c", "#563dea", "white", "#ff9800"]
  }),
  computed: {
    Customizer_drawer: sync("app/Customizer_drawer"),
    SidebarColor: sync("app/SidebarColor"),
    navbarColor: sync("app/navbarColor")
  },
  watch: {
    themecolor(val) {
